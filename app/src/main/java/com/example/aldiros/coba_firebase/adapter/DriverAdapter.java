...
//            user_umur = (TextView) itemView.findViewById(R.id.umur);
    ...
    public DriverAdapter(Context context, List<driverUser> postList) {
    ...
    public void onBindViewHolder(DriverAdapter.ViewHolder holder, int position) {
        final driverUser post = postList.get(position);
