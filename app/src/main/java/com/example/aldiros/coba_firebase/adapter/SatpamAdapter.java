...
public class SatpamAdapter extends RecyclerView.Adapter<SatpamAdapter.ViewHolder> {
    Context context;
    List<satpamUser> postList;
    ...
    public SatpamAdapter(Context context, List<satpamUser> postList) {
        this.context = context;
        this.postList = postList;
    }

    @Override
    public SatpamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SatpamAdapter.ViewHolder holder, int position) {
        final satpamUser post = postList.get(position);
